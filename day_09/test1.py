# -*- coding: utf-8 -*-
"""
Created on Fri Apr 29 16:10:13 2022
...
imputer_num = SimpleImputer(#missing_values=None, 
                            strategy='mean')
imputer_obj = SimpleImputer(#missing_values=None, 
                            strategy='most_frequent')


from sklearn.pipeline import Pipeline
num_pipe = Pipeline([('imputer_num',imputer_num),('scaler',scaler)])

from sklearn.pipeline import Pipeline
obj_pipe = Pipeline([('imputer_obj',imputer_num),('encoder',scaler)])
...
ct = ColumnTransformer([('num_pipe',num_pipe,num_columns),('obj_pipe',obj_pipe,obj_columns)])
